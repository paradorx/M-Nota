...
public class List_note extends SherlockFragmentActivity {
	...
	List_note_FragmentAdapter mAdapter;
    ViewPager mPager;
    PageIndicator mIndicator;
	 ...
	 @Override
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
	    	...
	    	case REFRESH:
	    		Toast.makeText( List_note.this, "Button REFRESH is clicked", Toast.LENGTH_SHORT).show();
	    		return true;
	    ...
	    public void openIntent(int intentInput){
	    	...
	    	case SUBJECT:
	    		i = new Intent(this, List_subject.class);
	            startActivity(i);
	    		break;
	    		
	    	case PREFS:
	    		i = new Intent(this, Menu_tetapan.class);
	            startActivity(i);
	    		break;
	    		
	    	case HOME:
	    		i = new Intent(this, HomeMenu.class);
