...
public class HomeMenu extends SherlockActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	int theme = R.style.Theme_Sherlock_Light_DarkActionBar_ForceOverflow;
    	setTheme(theme);
    ...
    public void openIntent(int intentInput){
    	...
    	case NOTE:
    		i = new Intent(this, List_note_TitlesWithListener.class);
            startActivity(i);
    		break;
