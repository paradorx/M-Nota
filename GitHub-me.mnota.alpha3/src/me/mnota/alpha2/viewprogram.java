...
public class viewprogram extends List_subject {
	
	static String parentId;
	
	private static final String TABLE_NAME="program";
	private static final String TABLE_PARENT_NAME="fakulti";
	...
	protected void openChild(String viewgettext) {
		...
		try{
			...
			viewsubjek.setFakultiId(thisId);
			
			Intent i = new Intent(this, viewsubjek.class);
	        startActivity(i);
